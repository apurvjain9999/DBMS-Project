...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Features - Bank of Jaipur</title>
        <style>
            .content_customer ul{
                margin-left:150px;
                margin-top:50px;
        ...
        <div class='content_customer'>
             <h3 style="text-align:center;color:#ff0066;"><u>Online Banking features</u></h3>
           <ul>
             ...
             <li> All three of them(customer, staff and admin) can change their password. </li>
