...
<html>
    ...
    <body>
        ...
        <div class="header">
            <img src="lk.jpg" height="100%" width="100%" />
            </div>
            <div class="navbar">
    ...
    <a href="t_c.php"><h3>Terms and conditions</h3></a>
    <a href="faq.php"><h3>FAQ'S</h3></a>
            ...
            <div class="right_panel">
                    ...
                    <ul>
                        ...
                        <li>Bank of Jaipur or any of its representative never sends you email/SMS or calls you over phone to get your personal information, password or one time SMS (high security) password.</li>
                        <li>Any such e-mail/SMS or phone call is an attempt to fraudulently withdraw money from your account through Internet Banking. Never respond to such email/SMS or phone call. Please report immediately on if you receive any such email/SMS or Phone call. Please lock your user access immediately.
</li>
                    </ul>
                </div>
