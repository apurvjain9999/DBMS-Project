...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Safe Online Banking - Bank of Jaipur</title>
    ...
    color:#2E4372;
        ...
        <div class='content_customer' style="background: linear-gradient(to bottom, rgba(255,204,255,1) 0%,rgba(255,153,255,1) 98%,rgba(255,153,255,1) 100%); ">
            <h3 style="text-align:center;color:#ff0066;"><u>Safe Online Banking Tips</u></h3>
              
            <div class="contact">
            <h3 style="color:#ff0066;"><u>Please ensure the following before logging in</u></h3> 
            <ul>
            ...
            <h3 style="color:#ff0066;"><u>Beware of Phishing Attacks</u></h3>
            <ul>
