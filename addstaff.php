...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Add Staff - Bank of Jaipur</title>
...
<?php include 'header.php'; ?>
        ...
        <div class='content_addstaff'>
            ...
            <div class='addstaff' style="background: linear-gradient(to bottom, rgba(255,204,255,1) 0%,rgba(255,153,255,1) 98%,rgba(255,153,255,1) 100%); "  style="background: linear-gradient(to bottom, rgba(255,204,255,1) 0%,rgba(255,153,255,1) 98%,rgba(255,153,255,1) 100%); ">
